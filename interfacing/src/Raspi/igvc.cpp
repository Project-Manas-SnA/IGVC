...
double prvErr_R = 0,intgtr_R = 0,rpm_r=10,setVel_Right=6,kp_r=.35,ki_r=1.1,kd_r=0;
...
double prvErr_L = 0,intgtr_L = 0,rpm_l=10,setVel_Left=0,kp_l=.35,ki_l=1.1,kd_l=0;
int pwmVal_Left;
